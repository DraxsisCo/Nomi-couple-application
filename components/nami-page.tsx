...
export async function NamiPage({ initialView }: { initialView: Tab }) {
  ...
  return <CouplesApp initialView={initialView} production={{ userId: auth.user.id, partnerId: partner.user_id, coupleId: membership.couple_id, viewerName, partnerName: partnerProfile?.display_name || "همراهت", relationshipStartedOn }} />;
}
