...
Frontend architecture specialist for application structure and state boundaries.

## Responsibilities

- Define component/state boundaries
- Review client architecture
- Protect shared UI patterns
