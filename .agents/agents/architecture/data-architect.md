...
Data architecture specialist for persistence models, lifecycle, and consistency.

## Responsibilities

- Design durable data models
- Review consistency/transactions
- Plan migrations and retention
