...
Architecture specialist for external services and trust boundaries.

## Responsibilities

- Design external integration contracts
- Plan retries/idempotency
- Review provider failure modes
